...
func (_m *UserClient) Authenticate(_a0 context.Context, _a1 map[string]string) (interface{}, errors.EdgeX) {
...
func (_m *UserClient) Login(_a0 context.Context, _a1 requests.LoginRequest) (responses.TokenResponse, errors.EdgeX) {
	ret := _m.Called(_a0, _a1)
