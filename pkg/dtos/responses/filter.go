...
type MultiFiltersResponse struct {
	...
	Filters                              []dtos.Filter `json:"devices"`
}

func NewMultiFiltersResponse(requestId string, message string, statusCode int, totalCount uint32, devices []dtos.Filter) MultiFiltersResponse {
